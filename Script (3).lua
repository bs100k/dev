...
local inline = {{{text="قنآهہ‏‏ آلسـورس : 🍃",url="t.me/@BS100K"}}}
...
🗑¦ مسح الفحولا •⊱ لمسح الاعضاء المستفحلين 
...
return [[
   سورس خاص بالمطور اذا تبي نسخه @Jll_il ب $
]]
end
...
local su = {
"موجود حبيبي المطور تفضل🌚❤",
"هـا حہياتے گہول 😊💞؟️",
"ها يابــعد دگــات كِـུ֘͢ـ᷀͛❤️ـۢۢۢ͜͢͡ـلُـུ֤͋꩸֤ـֿ֤ࣵـبّـيَ🤤❤️",
"يابعد روح ["..Bot_Name.."] 😘❤️",
"هلا بمطوري العشق أمرني😍"}
local ss97 = {
"ها حياتي😻","نـايم حبـي نـايم:☹💛",
"باقي ويتمدد 😹😎","ها حبي 😍","دآخـابر بعـدين تعـال😒","اجيت اجيت كافي لتصيح 🙄💕",
...
local sh = {
"عــافيتي مـطور يـاهـلا 🌝💕️",
"هلوات نـورت مطـوري آلعشـق😍🙊",
"آججہٰهٰہٰٖ تہٰآججہٰ رَآسہٰيٰ 😇❤️",
"ٱجتـُي آلـٰٖـ͜دوخـٰۛـۛه ⁽🙄😹❤️",
"ۿلهۿَ مـِٰ̲ـطوري ټجہٰۧﹻراﺳيُ 😍🖤",
}
local lovm = {
"اكرهك 😒👌🏿",
"منو لـ كلك احبك؟ 😒👌🏻",
...
local hss = {" قد قام مطور السورس بضافه افضل التقنيات ولتحديثات الى سورس نوبي الرسمي تم تطوير وبرمجه السورس من قبل\n- المطور #Ahmed آحـمد ♥️\n-  معرف المطور 💌• @hmndush \n- قنـات السورس 📡• @tntnobe\n⁛⁚⁛⁚⁛⁚⁛⁚⁛⁚⁛⁚⁚⁛⁚⁛⁚⁛⁚⁛⁛⁚⁛⁚⁛⁚⁛⁚⁛⁚⁛⁚⁛⁚⁛⁚⁛⁛⁛⁚⁛⁚⁛⁚⁛⁚⁛⁚⁛⁚⁚⁛⁚⁛⁚⁛⁚⁛⁛⁚⁛⁚⁛⁚⁛⁚⁛⁚⁛⁚⁛⁚⁛⁚⁛⁛⁛⁚⁛⁛⁚⁛⁚⁛⁚⁛⁚⁛⁚⁛⁚⁛⁚⁛⁚⁛⁛⁛⁚⁛⁛⁚⁛⁚⁛⁚⁛⁚⁛⁚⁛⁚⁛⁚⁛⁚⁛⁛⁛⁚⁛⁛⁚⁛⁚⁛⁚⁛⁚⁛⁚⁛⁚\nشكرا لكم لاستخدام سورس نوبي 🍂️",
}
...
elseif Text== "احمد" or Text=="حمندوش" or Text== "مطور السورس" then 
...
elseif Text== "انته وين"  then return sendMsg(msg.chat_id_,msg.id_,"طـآلع مـمـوجود شـتريد مـني😏")
...
elseif Text== "اجيت" or Text=="اني اجيت" then return  sendMsg(msg.chat_id_,msg.id_,"• ۿلهۿَ بـِٰ̲ـريحُهۃ ۿݪيِ 🌚😻")
...
elseif Text== "خاصك"  then return sendMsg(msg.chat_id_,msg.id_,"عيب آبني آثگل شـوي 😐💦")
...
return sendMsg(msg.chat_id_,msg.id_,"تمۘٱمۘ ونۨـہتهہ شلونۨگ، شخۡبٱرك🌝💞")
elseif Text== "يومه فدوه"  then return sendMsg(msg.chat_id_,msg.id_,"فدؤه الج حياتي 😍😙")
elseif Text== "روح"  then return sendMsg(msg.chat_id_,msg.id_,"ٲﺭۄحح،💙🏃🏿")
elseif Text== "افلش"  then return sendMsg(msg.chat_id_,msg.id_,"آفلش رآسـگ بل قندرهہ😎😂")
elseif Text== "احبج"  then return sendMsg(msg.chat_id_,msg.id_,"ٱدعـُبَٰـُل حـٰٖـ͜يـٰۛـۛٱتـٰٖيٰٓ ⁽🙄🍃")
...
elseif Text== "نرتبط" or Text== "مرتبط"  then return sendMsg(msg.chat_id_,msg.id_,"• ﺂسہٰۧﹻﭫ ﻣـَرﺗــۧبطَ پثَقهِۃ ﺂۿـٰٖۧليَ 😹🤞🏿")
elseif Text== "زاحف"  then return sendMsg(msg.chat_id_,msg.id_,"شـہٰ۪۫ﹷﯛيٰۧ شـہٰ۪۫ﹷﯛيٰۧ م̷ــْـﯛ̲୭ هِــيـٰ۫جہ تَـزحـٰۛـۛف ،🦎😹")
elseif Text== "ضحك" or Text== "اضحك"  then return sendMsg(msg.chat_id_,msg.id_,"✥ ۿٌۿٌۿٌۿـٌ(ﺿﹷٰﹻﺤڳت😹)ـههــۣۙـہ↜✹")
elseif Text== "حلو"  then return sendMsg(msg.chat_id_,msg.id_,"• َﺂﺎبـٰوسَ ؏َﻴـٓوﯟنڪ ﺎݪحلۏﺎ🙊💗'️")
elseif Text== "🌝"  then return sendMsg(msg.chat_id_,msg.id_,"• ۿذٱ ۏيۿڪ ﻟﮧﯚ فـݪتـﮧرَ ، 🙈♥️")
elseif Text== "🌚"  then return sendMsg(msg.chat_id_,msg.id_," بـۧيڪ/جَ طـَﮧنَ ﭑنوثـۧهۿﮧ ﯡنبِـﮧيَّ 😹👌")
elseif Text== "تبادل"  then return sendMsg(msg.chat_id_,msg.id_,"هہآآذ گروب تفآعل مـوو تبآدل يلآ ديي😠😏")
elseif Text== "عاش"  then return sendMsg(msg.chat_id_,msg.id_,"الحلو وبن آلحلوو🌝💕")
elseif Text== "ورده" or Text== "وردة" then return sendMsg(msg.chat_id_,msg.id_,"أنت/ي  عطرها 😍🌸")
elseif Text== "شسمك"  then return sendMsg(msg.chat_id_,msg.id_,"🧙🏽‍♂️¦ أسمي ["..Bot_Name.."]\n📬️¦ آختصـآصـي حمـآيهہ‏ آلمـجمـوعآت\n📛┊مـن آلسـبآم وآلتوجيهہ‌‏ وآلتگرآر وآلخ...\n🔛¦ ضيفني لكروبك ورفعني مشرف بلكروب وارسل تفعيل داخل الكروب")
...
elseif Text== "حياتي" then return sendMsg(msg.chat_id_,msg.id_,"ها حياتي گہول 🙄💕")
elseif Text== "عمري" then return sendMsg(msg.chat_id_,msg.id_,"ﻓ̲دّيَت̲ 🙊عـﻣ̲ڔﮖ ﺣّ͠ـبّـيَبّـيَ 🌚💞")
elseif Text== "اسكت"or Text== "اسكتي"  then return sendMsg(msg.chat_id_,msg.id_,"وك معلم 🙂💞")
elseif Text== "بتحبني" then return sendMsg(msg.chat_id_,msg.id_,"اوف اذا ماحبك احب منو 😘")
elseif Text== "المعزوفه" or Text=="المعزوفة" or Text=="معزوفه" then 
return sendMsg(msg.chat_id_,msg.id_,"طرطاا طرطييي طرطاا 😂👌")
elseif Text== "موجود" then return sendMsg(msg.chat_id_,msg.id_," ڳولَ ؏مريِّ😊❤️")
elseif Text== "اكلك" then return sendMsg(msg.chat_id_,msg.id_,"آيہ حہياتے گہول 😊💞؟")
elseif Text== "فدوه" or Text=="فدوة" or Text=="فطوه" or Text=="فطوة" then  
return sendMsg(msg.chat_id_,msg.id_,"لكلبك/ج 😍❤️")
elseif Text== "وخر"  then return sendMsg(msg.chat_id_,msg.id_,"تٍمٌاَْمٌ اَْسفُ ولّلّهً ☹️🍭")
elseif Text== "دي"  or Text== "ديي" then return sendMsg(msg.chat_id_,msg.id_,"مًيِّتٌـ عٌلَيِّکْ/چ قُأّبًلَ دٍوٌخِـخِـر😑👋")
elseif Text== "اشكرك" then return sendMsg(msg.chat_id_,msg.id_,"دَلَلَ حَيَاتَيَ خَادَمَ صَغَيَرَ😍❤️")
elseif Text== "😉"  then return sendMsg(msg.chat_id_,msg.id_,"عٍيبَ وولُِڪ لُِتغمز آستحٍي 😢💘₎")
elseif Text== "😑"  or Text==  "😑😑" or Text==  "😑😑😑" then return sendMsg(msg.chat_id_,msg.id_,"شبيك كالب خلقتك چنك جعفر بلايس 😡😂")
elseif Text== "اطردني"  then return sendMsg(msg.chat_id_,msg.id_,"واني شعلي؟ 😂")
elseif Text== "طردني"  then return sendMsg(msg.chat_id_,msg.id_,"ديـي لك لدخلني بيكك😏💞")
elseif Text== "باي" then return sendMsg(msg.chat_id_,msg.id_,"ٱللهۂَ ويۧٱك خۡلصنۨــہهۂَ 😂؟،♥️")
elseif Text== "🙄🙄"  then return sendMsg(msg.chat_id_,msg.id_,"نزﻟ̣̣ عّينڪْ/چ عّيبّـ ٱبّـني 😌😂💛 ء")
elseif Text== "🙄"  then return sendMsg(msg.chat_id_,msg.id_,"• نٍٰـہزًَلْٰ عٍِّيَٰـنٍٰكٍٰ عٍِّيَٰـﮧبٌِٰ🌚😹ֆ")
elseif Text== "شسمج"  then return sendMsg(msg.chat_id_,msg.id_,"اسمي زوزو عمري 18 😂؟ تعال خاص نكبل 😢💞")
elseif Text== "اني"  then return sendMsg(msg.chat_id_,msg.id_,"• آﻧ تَہَٰـེ̲ـﮪـ̯͡ﮪﮧ‘ وًآحہٰٰدُ ف͒ہٰٰآشِٰہٰٰل وًمـلطۨہٰٰلطۨہٰٰ 🌚😹💚")
elseif Text== "نورت"  then return sendMsg(msg.chat_id_,msg.id_,"نۨــہورك هۂَهۂَٱذ غلبيۧ 😹🙂🖤")
elseif Text== "نورتي"  then return sendMsg(msg.chat_id_,msg.id_,"نِْـِْـــِْ(💓)ِْــــًِـًًْـــِْـِْـِْـورِْكِْ🌚❤️")
elseif Text== "الله"  then return sendMsg(msg.chat_id_,msg.id_,"رب الكون وماي لعيون ولكلكسي الايفون😂😏")
